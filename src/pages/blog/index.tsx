      ...
      <div className="sm:flex justify-start     ">
        ...
        <div className="sm:w-9/12 w-full  sm:mt-0 mt-5">
          <div className=" grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-2">
            {[
              1, 2, 3, 34, 53, 563, 6, 343, 245, 62, 2, 5, 4, 2, 3, 32, 6, 3, 3,
            ].map((v, i) => (
              <div className="  w-full">
                <img
                  src="https://bestwebcreator.com/shopwise/demo/assets/images/blog_small_img7.jpg"
                  alt=""
                />
                <div className="p-3 shadow-lg">
                  <h2 className="font-semibold hover:text-rose-500 ">
        ...
        <div className="sm:w-4/12 w-full overflow-hidden ml-3">
          ...
          <div className="mt-8">
            ...
            {[1, 2, 3].map((v, i) => (
              <div
                key={i}
                className="flex justify-start items-center gap-x-3 mt-5"
              >
                <img
            ...
            <div className=" relative   flex justify-center items-center group">
              <img
                src="https://bestwebcreator.com/shopwise/demo/assets/images/sidebar_banner_img.jpg"
                alt=""
                className=" bg-cover"
              />
              <div className=" absolute  top-[50%] w-[40%] text-white">
                ...
                <button className="py-2 border  px-3 hover:bg-white hover:text-black rounded font-extrabold duration-300">
                  Shop now
                </button>
              </div>
            </div>
